<%@ Control Language="C#" AutoEventWireup="true" CodeFile="viewmanufacturers.ascx.cs"
    Inherits="Admin_uc_viewmanufacturers" %>
<div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="true"
        DataKeyNames="MaNSX" CssClass="gridview_display" OnRowEditing="GridView1_RowEditing"
        OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating"
        OnRowDeleting="GridView1_RowDeleting">
        <Columns>
            <asp:BoundField DataField="MaNSX" HeaderText="ID" ReadOnly="True" SortExpression="MaNSX" />
            <asp:BoundField DataField="TenNSX" HeaderText="Name" SortExpression="TenNSX" />
