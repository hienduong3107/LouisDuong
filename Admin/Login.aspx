...
<body id="login-bg">
    ...
    <div id="login-holder">
        ...
        <div id="logo-login">
            <a href="index.html">
                <img src="images/shared/logo.png" width="156" height="68" alt="" /></a>
        </div>
        <!-- end logo -->
        <div class="clear">
        </div>
            ...
            <div id="login-inner">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPassword" runat="server" CssClass=login-inp onfocus="this.value=''" TextMode="Password"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
        ...
        <div id="forgotbox">
            <div id="forgotbox-text">
                Nhập địa chỉ Email để lấy lại password</div>
            <!--  start forgot-inner -->
            <div id="forgot-inner">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtUser_forgot" runat="server" CssClass=login-inp></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
