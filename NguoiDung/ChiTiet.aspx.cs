...
public partial class ChiTiet : System.Web.UI.Page
{
    ...
    {
        CKE1.config.toolbar = "Basic";
        CKE1.EnterMode = CKEditor.NET.EnterMode.BR;
    }
    #region Xu Ly
    ...
    protected void btnGui_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    string sMaSP = Request.QueryString["MaSP"].ToString();
                    SanPhamDTO spDTO = new SanPhamDTO();
                    spDTO.CamNhan = CKE1.Text;
                    spDTO.Ma = int.Parse(sMaSP);
                    spDTO.NgayCamNhan = DateTime.Now.ToString();
                    spDTO.NguoiCamNhan = Session["TenDangNhap"].ToString();
                    if (SanPhamBUS.ThemCamNhan(spDTO) == true)
                        Response.Write("<script type='text/javascript'>"
